...
import { ChartPie, Store } from "lucide-react";
import type React from "react";
import { useLocation, useNavigate } from "react-router-dom";

const platformMenu = [
  { label: "Dashboard", to: "/admin", icon: ChartPie },
  { label: "Tiendas", to: "/admin/stores", icon: Store },
]

export const AdminbarMenu = ():React.ReactElement => {
